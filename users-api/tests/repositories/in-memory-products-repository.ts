import type { ProductsRepository } from "../../src/domain/application/repositories/products-repository";
import type { Product } from "../../src/domain/enterprise/entities/product";
